...
$.getJSON("/savedArticles", function(data){
	...
	for (var i = 0; i < data.length; i++){
 	...
 	$("#savedArticles").append("<div class='panel panel-default article' data-id='" + data[i]._id + "'>" + data[i].title + "<br/>" + "<a href=>" + website + data[i].link + "</a>"+"</p>"+ '<button class="save-article">' + "save"+ "</button>" + "</div>"  );
	};
});
